...
def parse_arguments():
    ...
    parser.add_argument(
        "--root-path", type=str, default="data/waymo_open_dataset_motion_v_1_1_0/uncompressed/tf_example"
    )
    parser.add_argument(
        "--out-path", type=str, default="data/waymo_open_dataset_motion_v_1_1_0/rasterized_vec"
    )
...
def preprocess_worker(
    ...
    data = pickle.dumps(raster_data)
    data = lz4.compress(data)
    with open(out_dir / f"{scenario_id}.lz4", "wb") as f:
        f.write(data)
...
def main():
    ...
    # train_out_path = out_path / "training"
    ...
    val_out_path = out_path / "validation"
