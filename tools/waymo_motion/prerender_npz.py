...
def parse_arguments():
    ...
    parser.add_argument(
        "--root-path", type=str, default="data/waymo_open_dataset_motion_v_1_1_0/preprocessed_npz"
    )
    parser.add_argument(
        "--out-path", type=str, default="data/waymo_open_dataset_motion_v_1_1_0/rasterized"
    )
